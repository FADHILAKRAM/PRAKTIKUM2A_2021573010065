...
<html>
    <head>
        ...
        <style>
            body{
                background-image: url('assets/img/rumput.jpg');
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'home') || !isset($_GET['x']) ? 'active bg-success' : 'link-dark'; ?>"
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'menu') ? 'active bg-success' : 'link-dark'; ?>"
                                href="menu"><i class="bi bi-table me-2 mb-1"></i>Jadwal</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'order') ? 'active bg-success' : 'link-dark'; ?>"
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'report') ? 'active bg-success' : 'link-dark'; ?>"
