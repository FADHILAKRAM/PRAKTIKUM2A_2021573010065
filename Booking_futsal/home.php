...
<body>
  ...
  <div class="card mt-3" style="width: 40rem;">
    <img src="img/futsal5.jpg" class="card-img-top" alt="..." style="width:600px;height:200px;">
    <div class="card-body">
  ...
  <div class="container">
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
      <div class="col-3">
        ...
        <img src="img/ball.png" style="width:110px;height:110px;">
        <h6>GALAXY FUTSAL</h6>
      </div>
      ...
      <div class="col-3">
        <a href="#" class="nav-link p-0 text-muted">lokasi</a></li>
      </div>
      ...
      <div class="col-3">
        <a href="#" class="nav-link p-0 text-muted">Penting</a></li>
      </div>
